Feature: Login
  ...
  Scenario: Normal Login
    Given I have a normal username and password
  ...
  Scenario: Locked Out User
    Given I have a locked out username and their password
  ...
  Scenario: Problem User
    ...
    Scenario: Invalid User Details
      Given I have an incorrect username and incorrect password
    ...
    Scenario: Invalid Username
      Given I have an incorrect username and correct password
    ...
    Scenario: Invalid Password
      Given I have an correct username and incorrect password
